...
public class RetirarController extends HttpServlet {
	...
	private void registrarGasto(HttpServletRequest request, HttpServletResponse response)
		...
		List<Cuenta> cuentasOrigen = DAOFactory.getFactory().getCuentaDAO().getCuentasIngresosYGastosPorPersona(persona);
	...
	private void confirmar(HttpServletRequest request, HttpServletResponse response)
		...
		CuentaDeIngresosYGastos cuentaDeOrigen = (CuentaDeIngresosYGastos) DAOFactory.getFactory().getCuentaDAO().getById(idCuentaOrigen);
		CuentaDeGastos cuentaDeDestino = (CuentaDeGastos) DAOFactory.getFactory().getCuentaDAO().getById(idCuentaDestino);
